...
<div class="container-fluid">
    ...
    <form method="post" action="/admin/">
        ...
        <div class="col-lg-4">
            ...
            <select class="form-select" name="id_armada">
        ...
        <div class="col-lg-4">
            ...
            <select class="form-select" name="id_codriver">
        ...
        <button type="submit" class="btn btn-primary">Tambah Laporan Admin Baru</button>
    </form>
</div>
