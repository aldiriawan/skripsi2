                    ...
                    <form method="post" action="/admin/">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('tanggal_trip') is-invalid @enderror"
                                id="tanggal_trip" name="tanggal_trip" value="{{ old('tanggal_trip') }}" autofocus
                                required>
                            @error('tanggal_trip')
                        ...
                        <div class="form-group">
                            <label for="id_rute" class="form-label">Nama Rute</label><br>
                            <select class="form-control" name="id_rute">
                                @foreach ($rutes as $rute)
                                @if (old('id_rute') == $rute->id)
                                <option value="{{ $rute->id }}" selected>{{ $rute->nama_rute }}</option>
                                @else
