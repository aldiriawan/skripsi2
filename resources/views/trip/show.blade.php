...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="h3 text-gray-800">Laporan Admin Tanggal : {{ strftime('%d %B %Y', strtotime($tanggal_trip)) }}</h1>
                ...
                <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/admin/{{ $t->id }}/edit" class="btn btn-warning btn-sm mr-2"><i
                                        class="fas fa-edit" data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="Edit Data Perjalanan"></i></a>
                                <form action="/admin/{{ $t->id }}" method="POST" class="d-inline"
