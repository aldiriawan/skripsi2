...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Edit Data Driver</h1>
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="/admin/driver/{{ $driver->nik_driver }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_driver') is-invalid @enderror"
                                id="nama_driver" name="nama_driver"
                                value="{{ old('nama_driver', $driver->nama_driver) }}" autofocus required>
                            @error('nama_driver')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nik_driver') is-invalid @enderror"
                                id="nik_driver" name="nik_driver" value="{{ old('nik_driver', $driver->nik_driver) }}"
                                required>
                            @error('nik_driver')
                            <div class="invalid-feedback">
                                {{ $message }}
                            ...
                            <div class="row">
                                <div class="col-2">
                                    ...
                                    <input type="text" class="form-control @error('umur_driver') is-invalid @enderror"
                                        id="umur_driver" name="umur_driver"
                                        value="{{ old('umur_driver', $driver->umur_driver) }}" required>
                                    @error('umur_driver')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <textarea type="text" class="form-control @error('alamat_driver') is-invalid @enderror"
                                id="alamat_driver" name="alamat_driver"
                                required>{{ old('alamat_driver', $driver->alamat_driver) }}</textarea>
                            @error('alamat_driver')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
