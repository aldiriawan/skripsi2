...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 my-1 text-gray-800">Tambah Driver Baru</h1>
    </div>
    <div class="col-lg-5">
        <form method="post" action="/admin/driver/">
            ...
            <div class="mb-2">
                ...
                <input type="text" class="form-control @error('umur_driver') is-invalid @enderror" id="umur_driver"
                    name="umur_driver" value="{{ old('umur_driver') }}" required>
                @error('umur_driver')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="mb-2">
                ...
                <input type="text" class="form-control @error('alamat_driver') is-invalid @enderror" id="alamat_driver"
                    name="alamat_driver" value="{{ old('alamat_driver') }}" required>
                @error('alamat_driver')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
