...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Tambah Co-Driver Baru</h1>
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="/admin/codriver/">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_codriver') is-invalid @enderror"
                                id="nama_codriver" name="nama_codriver" value="{{ old('nama_codriver') }}" autofocus
                                required>
                            @error('nama_codriver')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nik_codriver') is-invalid @enderror"
                                id="nik_codriver" name="nik_codriver" value="{{ old('nik_codriver') }}" required>
                            @error('nik_codriver')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
